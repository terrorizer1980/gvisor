...
var AMD64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		66:  syscalls.PartiallySupported("semctl", Semctl, "Options SEM_STAT, SEM_STAT_ANY not supported.", nil),
...
var ARM64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		191: syscalls.PartiallySupported("semctl", Semctl, "Options SEM_STAT, SEM_STAT_ANY not supported.", nil),
