...
const (
	...
	// ipv6HopByHopExtHdrUnnacountedLenWords is the implicit number of 8-octet
	...
	ipv6HopByHopExtHdrUnnacountedLenWords = 1
)
...
func (h IPv6SerializableHopByHopExtHdr) serializeInto(nextHeader uint8, b []byte) int {
	...
	wordsLen := totalLength/ipv6ExtHdrLenBytesPerUnit - ipv6HopByHopExtHdrUnnacountedLenWords
